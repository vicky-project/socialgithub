...
class SocialGithubServiceProvider extends ServiceProvider
{
  use PathNamespace;

  protected string $name = 'SocialGithub';

  protected string $nameLower = 'socialgithub';
  ...
  */
  public function boot(): void
  {
    ...
    $this->mergeConfigFrom(module_path($this->name, 'config/github.php'), 'services');
  }
